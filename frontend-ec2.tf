module "frontend_public_ec2_instance" {
  ...
  vpc_security_group_ids = [aws_security_group.frontend_public_ssh_ping_traceroute.id]
...
module "frontend_private_ec2_instance" {
  ...
  vpc_security_group_ids = [aws_security_group.frontend_private_ssh_ping_traceroute.id]
